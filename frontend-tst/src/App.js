  ...
  return (
    <>
      <Router>
        ...
        <Routes>
          <Route path="/users/manager/*" element={<Component.ManagerTopbar />} />
        </Routes>
        <Routes>
          <Route path="/users/admin/*" element={<Component.AdminTopbar />} />
        </Routes>
        ...
        <div className="container">
          ...
          <div className="others">
            ...
            <Routes>
              <Route path="/users/admin/extraleaves" element={<Pages.ExtraLeaves />} />
            </Routes>
            <Routes>
              <Route
                path="/users/admin/myleaves"
            ...
            <Routes>
              <Route path="/users/manager/extraleaves" element={<Pages.ExtraLeaves />} />
            </Routes>
            <Routes>
              <Route
                path="/users/manager/myleaves"
